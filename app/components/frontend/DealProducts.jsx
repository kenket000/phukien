          ...
          >
            ...
            <div className="product-list-small animated animated">
              ...
              <article className="row align-items-center hover-up">
                <figure className="col-md-4 mb-0">
                  <a href="shop-product-right.html">
                    <img src="/assets/imgs/shop/thumbnail-6.jpg" />
                  </a>
                </figure>
                <div className="col-md-8 mb-0">
                  <h6>
          ...
          >
            ...
            <div className="product-list-small animated animated">
              <article className="row align-items-center hover-up">
                <figure className="col-md-4 mb-0">
                  <a href="shop-product-right.html">
                    <img src="/assets/imgs/shop/thumbnail-7.jpg" />
                  </a>
                </figure>
                <div className="col-md-8 mb-0">
                  <h6>
              ...
              <article className="row align-items-center hover-up">
                <figure className="col-md-4 mb-0">
                  <a href="shop-product-right.html">
                    <img src="/assets/imgs/shop/thumbnail-8.jpg" />
                  </a>
                </figure>
                <div className="col-md-8 mb-0">
                  <h6>
              ...
              <article className="row align-items-center hover-up">
                <figure className="col-md-4 mb-0">
                  <a href="shop-product-right.html">
                    <img src="/assets/imgs/shop/thumbnail-9.jpg" />
                  </a>
                </figure>
                <div className="col-md-8 mb-0">
                  <h6>
          ...
          >
            ...
            <div className="product-list-small animated animated">
              <article className="row align-items-center hover-up">
                <figure className="col-md-4 mb-0">
                  <a href="shop-product-right.html">
                    <img src="/assets/imgs/shop/thumbnail-10.jpg" />
                  </a>
                </figure>
                <div className="col-md-8 mb-0">
                  <h6>
              ...
              <article className="row align-items-center hover-up">
                <figure className="col-md-4 mb-0">
                  <a href="shop-product-right.html">
                    <img src="/assets/imgs/shop/thumbnail-11.jpg" />
                  </a>
                </figure>
                <div className="col-md-8 mb-0">
                  <h6>
              ...
              <article className="row align-items-center hover-up">
                <figure className="col-md-4 mb-0">
                  <a href="shop-product-right.html">
                    <img src="/assets/imgs/shop/thumbnail-12.jpg" />
                  </a>
                </figure>
                <div className="col-md-8 mb-0">
                  <h6>
