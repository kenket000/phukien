...
$(".product-category-1").not(".slick-initialized").slick({
  arrows: true,
  infinite: true,
  slidesToShow: 1,
  slidesToScroll: 1,
...
$(".product-modal").not(".slick-initialized").slick({
  slidesToShow: 1,
  slidesToScroll: 1,
  arrows: false,
  fade: true,
...
$(".product-main").not(".slick-initialized").slick({
  slidesToShow: 1,
  slidesToScroll: 1,
  arrows: false,
  fade: true,
...
$(".product-main-2").not(".slick-initialized").slick({
  slidesToShow: 1,
  slidesToScroll: 1,
  arrows: false,
  fade: true,
...
$(".product-main-1").not(".slick-initialized").slick({
  slidesToShow: 1,
  slidesToScroll: 1,
  arrows: false,
  fade: true,
...
$(".notification-slider").not(".slick-initialized").slick({
  slidesToShow: 1,
  slidesToScroll: 1,
  dots: false,
  vertical: true,
